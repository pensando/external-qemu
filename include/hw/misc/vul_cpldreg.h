...
static inline void cpld_regs_init(cpld_reg *regs)
{
    ...
    regs[CPLD_REG_RESETCODE].cpld_access = CPLD_SUC_RW_ACCESS | CPLD_SOC_RW_ACCESS ;
    regs[CPLD_REG_RESETCODE].val = 0;

    regs[CPLD_REG_RESETCODE_PAST].off = CPLD_REG_RESETCODE_PAST;
    regs[CPLD_REG_RESETCODE_PAST].cpld_access = CPLD_SUC_RW_ACCESS | CPLD_SOC_RW_ACCESS ;
    ...
    regs[CPLD_REG_RESET_REASON0].cpld_access = CPLD_SUC_RW_ACCESS | CPLD_SOC_RW_ACCESS ;
    regs[CPLD_REG_RESET_REASON0].val = 0;

    regs[CPLD_REG_RESET_REASON1].off = CPLD_REG_RESET_REASON1;
    regs[CPLD_REG_RESET_REASON1].cpld_access = CPLD_SUC_RW_ACCESS | CPLD_SOC_RW_ACCESS ;
    regs[CPLD_REG_RESET_REASON1].val = 0;

    regs[CPLD_REG_RESET_REASON2].off = CPLD_REG_RESET_REASON2;
    regs[CPLD_REG_RESET_REASON2].cpld_access = CPLD_SUC_RW_ACCESS | CPLD_SOC_RW_ACCESS ;
    regs[CPLD_REG_RESET_REASON2].val = 0;

    regs[CPLD_REG_RESET_REASON3].off = CPLD_REG_RESET_REASON3;
    regs[CPLD_REG_RESET_REASON3].cpld_access = CPLD_SUC_RW_ACCESS | CPLD_SOC_RW_ACCESS ;
