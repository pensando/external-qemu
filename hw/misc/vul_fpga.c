...
static const Property vul_fpga_properties[] = {
...
static void vul_fpga_class_init(ObjectClass *klass, const void *data)
{
    ...
    device_class_set_legacy_reset(dc, vul_fpga_reset);
