...
static void vul_suc_sys_reset_hold(Object *obj, ResetType type)
{
    ssys_state *s = VUL_SUC_SYS(obj);
...
static void vul_suc_sys_reset_exit(Object *obj, ResetType type)
{
}
...
static const Property vul_suc_sys_properties[] = {
...
static void vul_suc_class_init(ObjectClass *oc, const void *data)
{
...
static void vul_suc_i2c_class_init(ObjectClass *klass, const void *data)
{
...
static void vul_suc_adc_class_init(ObjectClass *klass, const void *data)
{
    DeviceClass *dc = DEVICE_CLASS(klass);
...
static void vul_suc_sys_class_init(ObjectClass *klass, const void *data)
{
    DeviceClass *dc = DEVICE_CLASS(klass);
